...
namespace UzmanCrm.CrmService.Domain.Entity.CRM.CardExceptionDiscount
{
    // uzm_carddiscount
    public class CardExceptionDiscount
    {
        ...
        public string uzm_approvalexplanation { get; set; } = null;
        ...
        public string uzm_demandstorename { get; set; } = null;
