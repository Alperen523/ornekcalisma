...
namespace UzmanCrm.CrmService.Domain.Entity.CRM.CustomerEndorsement
{
    //uzm_customerendorsement
    public class CustomerEndorsement
    {
        ...
        public double? uzm_giftcardamount { get; set; } = null;
        ...
        public double? uzm_totalamount { get; set; } = null;
